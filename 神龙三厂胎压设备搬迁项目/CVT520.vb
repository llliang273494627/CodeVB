...
Friend Class CVT520
	...
	Public Property ComSettings() As String
		...
		Set(ByVal Value As String)
			...
			m_Comm.RThreshold = 1
			'    m_Comm.InputLen = 0
			m_Comm.InputMode = MSCommLib.InputModeConstants.comInputModeBinary
	...
	Private Sub m_Comm_OnComm(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles m_Comm.OnComm
		On Error Resume Next
		DelayTime(100) '原始是100ms
		Dim byt() As Byte
		'UPGRADE_WARNING: 未能解析对象 m_Comm.Input 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
		byt = m_Comm.Input
